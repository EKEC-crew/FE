    ...
    <div className="flex flex-col items-center justify-center w-full h-full px-[12.86%]">
      ...
      >
        ...
        <button
          type="submit"
          disabled={!isValid}
          className="relative flex items-center justify-center h-12 md:h-14 lg:h-[4.25rem] transition-all duration-200 hover:opacity-90 active:transform active:translate-y-0.5 mb-6 disabled:pointer-events-none"
          style={{ width: "27.08vw" }}
        >
          <img
            src={isValid ? emailSignInBtn : disabledBtn}
            alt="로그인 버튼"
