interface FeeSectionProps{
  ...
  setIsFeeRequired: (value: boolean) => void;
  feePurpose: string;
  setFeePurpose: (value: string) => void;
}

const FeeSection: React.FC<FeeSectionProps> = ({ fee, setFee, isFeeRequired, setIsFeeRequired, feePurpose, setFeePurpose }) => {
  return (
    <div className="mb-4">
