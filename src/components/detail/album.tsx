...
const albumData: AlbumItem[] = [
  { id: '1', src: 'https://images.unsplash.com/photo-1601758125946-3c45cbb6f8d0' },
];
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        <span className="font-semibold py-4 text-xl px-0 text-gray-800">앨범</span>
      </div>

      <div className="bg-[#f8f9fb] p-4 grid grid-cols-3 gap-4">
        {albumData.map((img) => (
          <div
            key={img.id}
        ...
        {[...Array(2)].map((_, index) => (
          <div
            ...
            className="flex items-center justify-center w-full h-40 cursor-pointer
                       ...
                       text-gray-400 text-6xl font-light bg-gray-100"
          >
            +
          </div>
        ))}
